...
export const MONTH_ALIAS = ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec']
...
export interface DatePickerProps {
    ...
    defaultYear?: number
    defaultMonth?: 'Jan' | 'Feb' | 'Mar' | 'Apr' | 'May' | 'Jun' | 'Jul' | 'Aug' | 'Sep' | 'Oct' | 'Nov' | 'Dec'
    defaultDate?: number
...
function scrollEventHandlers(
    ...
    onMonthIndexChange: (event: any) => void,
